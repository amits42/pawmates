  ...
  return (
    <Card>
      <CardHeader>
        ...
        <CardDescription>
          {action === "start"
            ? "Generate an OTP for the sitter to start the service"
            : "Generate an OTP for the sitter to complete the service"}
        </CardDescription>
      </CardHeader>
        ...
        {!otp ? (
          ...
          <div className="space-y-3">
            <div className="flex items-center justify-center p-6 bg-gray-50 rounded-lg">
              <div className="text-center">
                ...
                <p className="text-xs text-gray-500 mt-2">
                  Share this with the sitter to {action === "start" ? "start" : "complete"} the service
                </p>
              </div>
            </div>
            ...
            <Alert>
              ...
              <AlertDescription>
                This OTP will expire in {getTimeRemaining()} minutes. The sitter needs to enter this code to{" "}
