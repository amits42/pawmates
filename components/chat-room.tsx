...
interface Message {
  ...
  text: string
  senderId: string
  senderType: "pet_owner" | "sitter" | "admin"
  senderName: string
  timestamp: any
...
interface ChatRoomProps {
  ...
  currentUser: {
    id: string
    name: string
    type: "pet_owner" | "sitter" | "admin"
  }
  onClose?: () => void
}

export default function ChatRoom({ bookingId, currentUser, onClose }: ChatRoomProps) {
    ...
    <Card className="w-full max-w-2xl mx-auto h-[600px] flex flex-col">
      <CardHeader className="flex-shrink-0 border-b">
        ...
        <div className="flex gap-2">
          ...
          <Badge variant="outline">Sitter</Badge>
